...
func (a *Client) GetCampaignList(params *GetCampaignListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetCampaignListOK, error) {
	...
	if params == nil {
		params = NewGetCampaignListParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "GetCampaignList",
		Method:             "GET",
		PathPattern:        "/campaign_list",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetCampaignListReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetCampaignListOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	unexpectedSuccess := result.(*GetCampaignListDefault)
